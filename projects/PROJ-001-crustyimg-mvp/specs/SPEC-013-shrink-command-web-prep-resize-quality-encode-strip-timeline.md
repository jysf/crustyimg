...
- [x] **build** — completed 2026-06-15. PR #14 opened. All 181 tests pass; all gates green (cargo build/test/clippy --all-targets/fmt --check). encode_to_bytes made pub; stub_command_returns_not_implemented repointed to convert.
