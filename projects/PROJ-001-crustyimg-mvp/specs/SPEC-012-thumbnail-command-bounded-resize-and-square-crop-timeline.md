...
- [x] **build** — completed 2026-06-15 (Sonnet 4.6 subagent). All four gates pass (171 tests). run_pixel_op extracted; run_thumbnail + thumbnail_params wired; stub test repointed to shrink; 10 integration + 4 unit thumbnail tests written and green. PR #13 opened.
