...
```
estimated_usd prices each component separately, at the model's list anchors
(Opus $5/$25 per MTok, Sonnet $3/$15), with the standard cache multipliers:
  input           x1.00      output          x5.00  (i.e. the $25/$5 ratio)
  cache_creation  x1.25 input
  cache_read      x0.10 input
