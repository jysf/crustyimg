...
**Count:** **4 shipped-or-closed / 0 open** — re-derived by grep 2026-08-23.
...
> `STAGE-052` in PROJ-013**, carried unchanged with their evidence — nothing was summarised away.
> **Do not add new items here.** File them on STAGE-052.
