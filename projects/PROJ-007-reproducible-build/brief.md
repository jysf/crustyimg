...
**Count:** 2 shipped / 0 active / 2 pending (STAGE-020 build + STAGE-021 cache shipped; STAGE-022 lockfile next — blocked on the DEC-057 injective source→output constraint — then STAGE-023 watch)
