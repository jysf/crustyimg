...
Posts about building and using this spec-driven template — the what, the
why, and what came out of real use. These are **drafts**: written from
the project's history (`CHANGELOG.md`, `feedback/`, the brag log) and
meant to be edited into your own voice before publishing.
