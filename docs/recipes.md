...
- **Strip ALL metadata before publishing** **[today]** — `crustyimg strip photo.jpg`
- **Remove location only, keep copyright** **[today]** — `crustyimg clean --gps photo.jpg`
- **Stamp copyright/artist across a batch** **[today]**
  `crustyimg set --artist "Jane Doe" --copyright "© 2026 Jane Doe" photo.jpg`
- **Copy metadata from an original to a derivative** **[today]** — `crustyimg copy-metadata orig.jpg edited.jpg`
